		...
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="card shadow">
					<div class="card-body">
						<form:form action="${root}shop/modifyGoods_pro?goods_idx=${goodsBean.goods_idx}" modelAttribute="modifyGoodsBean" enctype="multipart/form-data">
							<div class="form-group">
								<form:label path="goods_name">상품명</form:label> <form:input path="goods_name" class="form-control" value="${goodsBean.goods_name}"/>
								<form:errors path="goods_name"/>
							</div>
							<div class="form-group">
								<form:label path="goods_price">상품가격</form:label> <form:input path="goods_price" class="form-control" value="${goodsBean.goods_price}"/>
