	...
	<div class="container-fluid">
		<div class="row flex-nowrap">
			...
			<div class="col-3 bd-sidebar">
				<ul class="nav">
					<li style="border-bottom:1px solid #ccc; margin-bottom:30px; padding-bottom:20px;"><h4>${ShopBean.shop_name}</h4></li>
			...
			<main class="col-9 py-md-3 pl-md-5 bd-content" role="main">
				<div class="container" style= "margin-top: 70px; margin-left:40px; ">
					<h4 style="border-bottom:1px solid #ccc; margin-bottom:30px; padding-bottom:30px;">${ShopBean.shop_name}'s Items</h4>
